...
/**Class representing command for getting flight brigade*/
public class FlightBrigadeCommand extends JSPCommand {
	
	/**
	 * Constructor
	 * @param operation - operation to be performed
	 */
	public FlightBrigadeCommand(JSPOperation operation) {
		super(operation);
	}

	@Override
	public void execute() throws AirlineException, DAOException, ServletException, IOException {
		operation.getFlightBrigade();
	}
