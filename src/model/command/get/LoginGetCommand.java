...
/**Class representing command for going to login page*/
public class LoginGetCommand extends JSPCommand{

	/**
	 * Constructor
	 * @param operation - operation to be performed
	 */
	public LoginGetCommand(JSPOperation operation) {
		super(operation);
	}
	
	@Override
	public void execute() throws AirlineException, DAOException, ServletException, IOException {	
		operation.goToLoginPage();
	}
}