...
/**Class representing command for going to chat page*/
public class ChatCommand extends JSPCommand{

	/**
	 * Constructor
	 * @param operation - operation to be performed
	 */
	public ChatCommand(JSPOperation operation) {
		super(operation);
	}
	
	@Override
	public void execute() throws AirlineException, DAOException, ServletException, IOException {	
		operation.goToChatPage();
	}
